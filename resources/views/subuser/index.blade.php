        ...
        <main class="subuser-management__content">
            ...
            <section class="subuser-management__panel" aria-labelledby="create-user-title">
                ...
                <form class="subuser-management__form" action="{{ route('subuser.store') }}" method="POST">
                    @csrf
                    <label>First name<input type="text" name="firstname" value="{{ old('firstname') }}" required autocomplete="given-name"></label>
                    <label>Last name<input type="text" name="secondname" value="{{ old('secondname') }}" required autocomplete="family-name"></label>
